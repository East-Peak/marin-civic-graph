...
EXPLICIT_RELATION_TYPES: dict[tuple[str, str], str] = {
    ("Agreement", "institution_id"): "RELATES_TO_INSTITUTION",
    ("Agreement", "counterparty_actor_id"): "COUNTERPARTY_ACTOR",
    ("Agreement", "program_id"): "RELATES_TO_PROGRAM",
    ("Agreement", "project_id"): "RELATES_TO_PROJECT",
    ("Agreement", "evidence_record_ids"): "EVIDENCED_BY",
    ("Amendment", "agreement_id"): "AMENDS_AGREEMENT",
    ("Amendment", "project_id"): "RELATES_TO_PROJECT",
    ("Amendment", "evidence_record_ids"): "EVIDENCED_BY",
    ...
    ("Decision", "project_id"): "RELATES_TO_PROJECT",
    ...
    ("MoneyFlow", "project_id"): "RELATES_TO_PROJECT",
    ("Project", "primary_place_id"): "PRIMARY_PLACE",
    ("Project", "jurisdiction_place_id"): "IN_JURISDICTION",
    ("Project", "record_ids"): "EVIDENCED_BY",
    ("Project", "related_decision_ids"): "RELATES_TO_DECISION",
    ("Project", "related_program_ids"): "RELATES_TO_PROGRAM",
