...
from identity_key_normalizers import _normalize_ein, _normalize_uei  # shared; Goal 0 re-export
from identity_key_registry import KEY_NORMALIZERS  # generated view; Goal 0
...
# _normalize_ein / _normalize_uei are re-exported from identity_key_normalizers,
# and KEY_NORMALIZERS is generated by identity_key_registry (both imported at top,
# Goal 0). A key with no registered normalizer still fails loud in
# propose_org_resolutions. The runtime keys (sos_id, committee_id) are registered
# into this shared dict by their lanes at import, exactly as before.
