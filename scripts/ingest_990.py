...
# M2c extraction (Decision 6): the resolver lives in the shared
# org_resolution module now — re-exported here so
# `from ingest_990 import propose_org_resolutions` keeps working unchanged.
from org_resolution import (  # noqa: F401  (re-export)
    _normalize_ein,
    _normalize_name,
